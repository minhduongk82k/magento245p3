...
class Edit extends \CS2\DuongDm\Controller\Adminhtml\Blog
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\CS2\DuongDm\Model\Blog::class);

        // 2. Initial checking
        if ($id) {
            $model->load($id);
            if (!$model->getDataByKey("blog_id")) {
        ...
        $this->_coreRegistry->register('cs2_duongdm_blog', $model);
