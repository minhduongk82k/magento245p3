...
class Edit extends \CS2\DuongDm\Controller\Adminhtml\Category
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\CS2\DuongDm\Model\Category::class);
        ...
        $this->_coreRegistry->register('cs2_duongdm_category', $model);
